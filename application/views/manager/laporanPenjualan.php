                ...
                <div class="col-md-4 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <?php echo form_open('manager/laporanPenjualan/cetak_lap_harian') ?>
                            <div class="row">
                                <div class="col-md-4">
                ...
                <div class="col-md-4 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <?php echo form_open('manager/laporanPenjualan/cetak_lap_bulanan') ?>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Bulan</label>
                ...
                <div class="col-md-4 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <?php echo form_open('manager/laporanPenjualan/cetak_lap_tahunan') ?>
                            <div class="row">
